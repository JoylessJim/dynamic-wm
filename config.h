...
static const char *fonts[]          = { "monospace:size=10", "symbolsnerdfont-regular:size=10" };
...
static const Key keys[] = {
	...
	/* start of program keybinds */
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
	/* end of program keybinds */
	
	/* start of window manager keybinds */
	...
	/* start of workspace switcher keys */
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
	...
	/* end of workspace switcher keys */
